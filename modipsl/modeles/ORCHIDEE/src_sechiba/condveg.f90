...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_sechiba/condveg.f90 $
!! $Date: 2018-03-16 15:06:04 +0100 (Fri, 16 Mar 2018) $
!! $Revision: 5106 $
!! \n
!_ ================================================================================================================================
...
!_ ================================================================================================================================
    ...
    CALL ioconf_setatt_p('LONG_NAME','Standard deviation of elevation')
    CALL restget_p (rest_id, 'zstd_not_filtered', nbp_glo, 2, 1, kjit, .TRUE., zstd_not_filtered, "gather", nbp_glo, index_g)
