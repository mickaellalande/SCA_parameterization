...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_parallel/ioipsl_para.f90 $ 
!! $Date: 2017-10-12 16:14:21 +0200 (Thu, 12 Oct 2017) $
!! $Revision: 4683 $
!! \n
!_ ================================================================================================================================
...
CONTAINS
  ...
  SUBROUTINE ipslerr_p (plev,pcname,pstr1,pstr2,pstr3)
    ...
    IF (plev == 3) THEN
       ...
       ! Force to pring text output using FLUSH only if cpp flag 1 is set in arch-XXX.fcm
