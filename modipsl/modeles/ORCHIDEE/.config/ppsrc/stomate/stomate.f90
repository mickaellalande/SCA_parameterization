...
!!
!! SVN :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_stomate/stomate.f90 $
!! $Date: 2019-11-29 15:30:50 +0100 (Fri, 29 Nov 2019) $
!! $Revision: 6368 $
!! \n
!_ ================================================================================================================================
...
!_ ================================================================================================================================
    ...
    CALL readstart &
         ...
         resp_hetero_d, resp_maint_d, resp_growth_d, co2_fire, co2_to_bm_dgvm, co2_to_bm_radia, &
...
!_ ================================================================================================================================
  ...
  SUBROUTINE stomate_finalize (kjit, kjpindex, index, clay, co2_to_bm_radia, assim_param) 
