!
! $Id: physiq_mod.F90 3612 2019-11-29 14:12:45Z acozic $
!
!#define IO_DEBUG
MODULE physiq_mod
...
!!    REAL, DIMENSION(klon,klev)     :: dql_sat
    ...
    INTEGER,  SAVE               :: iflag_bug_t2m_ipslcm61=0 ! 
...
! tau_gl : constante de rappel de la temperature a la surface de la glace - en secondes
       tau_gl=86400.*tau_gl
...
!>jyg
       ENDIF
        if ( iflag_bug_t2m_ipslcm61 == 0 ) THEN
          CALL borne_var_surf( klon,nbsrf,                     &
