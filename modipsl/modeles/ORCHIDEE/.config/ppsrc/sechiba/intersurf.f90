...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_sechiba/intersurf.f90 $
!! $Date: 2018-09-13 11:04:07 +0200 (Thu, 13 Sep 2018) $
!! $Revision: 5397 $
!! \n
!_ ================================================================================================================================
MODULE intersurf
...
!_ ==============================================================================================================================
  ...
  SUBROUTINE intersurf_initialize_2d (kjit, iim, jjm, kjpindex, kindex, xrdt, &
    ...
    !!- Initialize module for output with 1
    !
...
!_ ==============================================================================================================================
  ...
  SUBROUTINE intersurf_initialize_gathered (kjit, iim_glo, jjm_glo, kjpindex, kindex, xrdt, &
    ...
    !
    !! Change to be in the orchidee context for 1
    !
    ...
    CALL ipslnlf_p(new_number=old_fileout)
    !
    !! Change back to be in the LMDZ context for 1
    !
...
!_ ==============================================================================================================================
  ...
  SUBROUTINE intersurf_main_gathered (kjit, iim_glo, jjm_glo, kjpindex, kindex, xrdt, &
    ...
    IF (nbcf_into_LMDZ.GT.0) THEN
       DO ik=1, kjpindex
          DO i = 1, nbcf_into_LMDZ
             ...
             CASE("fCO2_nep")
                fields_in(ik,i) = znetco2(ik)
             CASE("fCO2_fLuc")
                fields_in(ik,i) = zcarblu(ik)
             CASE("fCO2_nbp")
                fields_in(ik,i) = znetco2(ik) + zcarblu(ik)
             CASE DEFAULT
                CALL ipslerr_p (3,'intersurf_main_gathered', &
    ...
    !
    !! Finalize the 1 orchidee context if it is the last call
    !
    IF (lrestart_write) THEN
