...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_sechiba/hydrol.f90 $
...
!! 8. 1 export of local variables, including water conservation checks
...
!_ ================================================================================================================================
    ...
    !! 10. 1 export of local variables, including water conservation checks
    ...
    !! 1. Nudging of soil moisture
       ...
       IF (MOD(kjit,INT(one_day/dt_sechiba)) == 1) THEN 
          ...
          IF (nudge_interpol_with_xios) THEN
             ! Read mc from input file. 1 interpolates it to the model grid before it is received here.
