...
!!
!! SVN     :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_sechiba/sechiba.f90 $
...
!$OMP THREADPRIVATE(temp_sol_add)
  REAL(r_std), ALLOCATABLE, SAVE, DIMENSION(:)    :: zstd_not_filtered !! Standard deviation of elevation (m)
!$OMP THREADPRIVATE(zstd_not_filtered)
CONTAINS
...
!_ ================================================================================================================================
    ...
    ! Add 1 default value where no snow
    DO ji=1,kjpindex
