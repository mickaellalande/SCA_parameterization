...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/tags/ORCHIDEE_2_0/ORCHIDEE/src_sechiba/hydrolc.f90 $
!! $Date: 2018-03-13 17:38:36 +0100 (Tue, 13 Mar 2018) $
!! $Revision: 5091 $
!! \n
!_ ================================================================================================================================
...
!_ ================================================================================================================================
  ...
  !! 0. Variable and parameter declaration
    ...
    REAL(r_std),DIMENSION (kjpindex), INTENT(in)            :: swnet            !! Net short wave radiation
    ...
    REAL(r_std), DIMENSION (kjpindex,nsnow), INTENT(out)    :: snowliq          !! Liquid water content (m)
...
!_ ================================================================================================================================
  ...
  !! 1. Water budget calculations:
    ...
    CALL hydrolc_soil(kjpindex, vevapnu, precisol, returnflow, reinfiltration, irrigation, tot_melt, mx_eau_var, &
         ...
         & gqsb, bqsb, dsg, dss, rsol, drysoil_frac, hdry, dsp, run_off_tot, drainage, humrel, &
...
!_ ================================================================================================================================
  ...
  SUBROUTINE hydrolc_soil(kjpindex, vevapnu, precisol, returnflow, reinfiltration, irrigation, tot_melt, mx_eau_var, &
       & veget, tot_bare_soil, ruu_ch, transpir,&
       & gqsb, bqsb, dsg, dss, rsol, drysoil_frac, hdry, dsp, run_off_tot, drainage, &
